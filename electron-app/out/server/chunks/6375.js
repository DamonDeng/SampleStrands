...
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50680);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(92509);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32085);
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(29751);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const lineFunction = (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .line */ .jvg)().x(function(d) {
    ...
    return d.y;
  }).curve(d3__WEBPACK_IMPORTED_MODULE_1__/* .curveBasis */ .$0Z);
...
const draw = function(text, id, _version, diagObj) {
  ...
  let g;
  g = new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__/* .Graph */ .k({
    multigraph: true,
    directed: true,
    compound: false
  }).setGraph({
...
function generateId(str = "", prefix = "") {
  ...
  return `${strWithHyphen(prefix)}${strWithHyphen(simplifiedStr)}${(0,uuid__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(
    str,
