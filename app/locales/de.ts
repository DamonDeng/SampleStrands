...
const de: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} Nachrichten mit Chat`,
    Actions: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Erzwingt das Hinzufügen eines simulierten systemweiten Prompts von Chat am Anfang der Nachrichtenliste bei jeder Anfrage",
    },
    Update: {
