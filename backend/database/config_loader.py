...
class ConfigurationLoader:
    ...
    def load_models_from_json(self) -> bool:
        ...
        try:
            ...
            with get_db_session() as session:
                ...
                session.commit()
                logger.info(f"✅ Loaded {len(db_models)} supported models into database")
                return True
    ...
    def load_all_configurations(self) -> bool:
        """Load all configurations from JSON files into database."""
        logger.info("🔄 Loading all configurations into database...")
        
        models_success = self.load_models_from_json()
